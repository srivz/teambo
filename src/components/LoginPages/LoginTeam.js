    ...
    <div className="container mt-5 login-container">
      <div className="form-box">
        ...
        <h5 className="mt-3 text-center">Let's start {text}!</h5>
          ...
          <button type="button" className="btn btn-primary bg-blue w-100 rounded-4" style={{ background: "#3975EA" }}>Log in</button>
          <h6 className="text-center mt-1">or</h6>
          <button type="button" className="btn btn-light w-100 rounded-4 login-button">
              <FontAwesomeIcon
