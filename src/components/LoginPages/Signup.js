                ...
                <div className="form-box1 ">
                    ...
                    <form>
                        <div className="form-group mb-4 ">
                            <div className="row">
                                <div className="col-sm-6 col-md-6">
                                    ...
                                    <input className="form-control rounded-3" id="name" type="name" name="name " placeholder="name" />
                                </div>
                                <div className="col-sm-6 col-md-6">
                        ...
                        <div className="form-group mb-4">
                            <div className="row">
                                <div className="col-sm-6 col-md-6">
                                    <label htmlFor="pwd" className="fw-bold">Company Name</label>
                        ...
                        <div className="form-group mb-4">
                            <div className="row">
                                <div className="col-sm-6 col-md-6">
                                    <label htmlFor="pwd" className="fw-bold">Designation</label>
                                    <select className="form-select" aria-label="Default select example">
                                ...
                                <div className="col-sm-6 col-md-6">
                                    <label htmlFor="pwd" className="fw-bold">Re-enter Password:</label>
                                    <input type="password" className="form-control" id="pwd" placeholder="Re-enter Password" />
                                </div>
                            </div>
                        </div>
                        <button type="button" className="btn btn-primary bg-blue w-100 rounded-4 mt-4">Sign Up</button>
                    </form>
                </div>
            </div>
        </div>
